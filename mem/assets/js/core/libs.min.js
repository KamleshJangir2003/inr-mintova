...
!(function (e, t) {
  ...
  !(function () {
    ...
    try {
      m.apply((n = i.call(j.childNodes)), j.childNodes),
    ...
    function ye(e, t, n, i) {
      ...
      if (((n = n || []), 1 === d.length)) {
        if (
          ...
          if (!(t = (r.find.ID(a.matches[0].replace(Q, Y), t) || [])[0]))
            return n;
    ...
    x.extend({
      ...
      ready: function (e) {
        (!0 === e ? --x.readyWait : x.isReady) ||
          ((x.isReady = !0),
          (!0 !== e && --x.readyWait > 0) || Q.resolveWith(m, [x]));
      },
    }),
    (x.ready.then = Q.then),
  ...
  x.ajaxSetup({
    ...
    x.each(["top", "left"], function (e, t) {
      x.cssHooks[t] = Ge(h.pixelPosition, function (e, n) {
        if (n)
          return (n = Ye(e, t)), Ue.test(n) ? x(e).position()[t] + "px" : n;
      });
    }),
      ...
      return function () {
        ...
        return (
          t.isFunction(arguments[0]) &&
            ((r = t.extend({}, arguments[1])).handler = arguments[0]),
          this.each(function () {
            var i = t.extend({}, r, { element: this });
            "string" == typeof i.context &&
              (i.context = t(this).closest(i.context)[0]),
              n.push(new e(i));
          }),
          n
        );
          ...
          if (L) {
            if (a) {
              var R,
                ...
                re = he(0, j[W], Z[W]),
                ie = x
                  ? j[W] / 2 - J - re - te - N.mainAxis
                  : Y - re - te - N.mainAxis,
                oe = x
                  ? -j[W] / 2 + J + re + ne + N.mainAxis
                  : G + re + ne + N.mainAxis,
            ...
            if (c) {
              var de,
                ...
                we = be ? ve : ge - j[me] - O[me] - _e + N.altAxis,
                xe = be ? ge + j[me] + O[me] - _e - N.altAxis : ye,
                Se =
                  g && be
                    ? (function (e, t, n) {
                        var r = he(e, t, n);
    ...
    var ye = {
        ...
        fn: function (e) {
          var t = e.state,
            ...
            s = Q(t, { elementContext: "reference" }),
            a = Q(t, { altBoundary: !0 }),
            l = me(s, r),
            c = me(a, i, o),
            u = ve(l),
  ...
  (function (e, t) {
    ...
    function P(e, t, n, r) {
      ...
      for (const [o, s] of Object.entries(i))
        o.includes(r) && O(e, t, n, s.callable, s.delegationSelector);
    }
    function N(e) {
      ...
      off(e, t, n, r) {
        ...
        if (void 0 === o) {
          ...
          for (const [n, r] of Object.entries(c)) {
            const i = n.replace(S, "");
            (a && !t.includes(i)) ||
              O(e, l, s, r.callable, r.delegationSelector);
          }
        } else {
    ...
    F.on(document, "click.bs.button.data-api", Y, (e) => {
      e.preventDefault();
    ...
    class Be extends q {
      ...
      hide() {
        if (this._isTransitioning || !this._isShown()) return;
        if (F.trigger(this._element, Oe).defaultPrevented) return;
    ...
    class pt extends q {
      ...
      _completeHide(e) {
        if (!F.trigger(this._element, Qe, e).defaultPrevented) {
    ...
    const Ot = ".bs.modal",
      ...
      Mt = `resize${Ot}`,
      $t = `click.dismiss${Ot}`,
      Wt = `mousedown.dismiss${Ot}`,
      qt = `keydown.dismiss${Ot}`,
      Bt = `click${Ot}.data-api`,
      zt = "modal-open",
      Ut = "show",
      Vt = "modal-static",
    ...
    F.on(document, Bt, '[data-bs-toggle="modal"]', function (e) {
      ...
      n && Qt.getInstance(n).hide(), Qt.getOrCreateInstance(t).toggle(this);
    }),
      U(Qt),
      v(Qt);
    const Yt = ".bs.offcanvas",
      Gt = ".data-api",
      Kt = `load${Yt}${Gt}`,
      Zt = "show",
      en = "showing",
    ...
    class pn extends q {
      ...
      show(e) {
        this._isShown ||
          ...
          ((this._isShown = !0),
          this._backdrop.show(),
          this._config.scroll || new jt().hide(),
          this._element.setAttribute("aria-modal", !0),
          this._element.setAttribute("role", "dialog"),
            ...
            this._queueCallback(
              () => {
                this._element.classList.remove(Zt, tn),
                  this._element.removeAttribute("aria-modal"),
                  this._element.removeAttribute("role"),
                  this._config.scroll || new jt().reset(),
    ...
    const Pn = {
      ...
      Nn = { ...On.DefaultType, content: "(null|string|element|function)" };
    class Fn extends On {
      static get Default() {
        return Pn;
      }
    ...
    class mr extends q {
      ...
      show() {
        ...
        const t = this._getActiveElem(),
          n = t ? F.trigger(t, Qn, { relatedTarget: e }) : null;
            ...
            () => {
              "tab" === e.getAttribute("role")
                ? (e.setAttribute("aria-selected", !1),
                  ...
                  F.trigger(e, Yn, { relatedTarget: t }))
  ...
  (function (e) {
    ...
    "function" == typeof define && define.amd
      ...
      ? ((t = require("jquery")),
        "undefined" == typeof window
          ...
          : (module.exports = e(t, window, window.document)))
        ...
        get: function (t) {
          ...
          return e.isPlainObject(t)
            ...
            : ((i = function (e, t, n) {
                var o, s, a;
                if ("" !== n)
                  for (var l = Q(n), c = 0, u = l.length; c < u; c++) {
      ...
      var s = t.oClasses,
        ...
        l =
          ...
          i !== r &&
            ...
            lt(n, i, "aDataSort"),
            n.ariaTitle || (n.ariaTitle = a.attr("aria-label"))),
          n.mData),
        c = Y(l),
        u = n.mRender ? Y(n.mRender) : null,
        d =
          ((n._bAttrSrc =
    ...
    function me(t, n, i) {
      if (
        ...
        return "data" === t ? n.aaData || n[t] : "" !== t ? Y(t)(n) : n;
      G(t)(n, i);
    }
    function ve(t) {
      function r(e) {
    ...
    function je(e) {
      ...
      if (e.bInitialised) {
        for (
          ...
          (r = o[t]).sWidth && (r.nTh.style.width = Qe(r.sWidth));
        ft(e, null, "preInit", [e]),
          le(e),
          ("ssp" == (s = gt(e)) && !a) ||
            ("ajax" == s
      ...
      n.scrollBarVis !== N && n.scrollBarVis !== r
        ...
        : ((n.scrollBarVis = N),
          ...
          "" === u
            ? ((A.width = "100%"),
              L &&
                ...
                (A.width = Qe(C.outerWidth() - h)),
              (p = C.outerWidth()))
            : "" !== d && ((A.width = Qe(d)), (p = C.outerWidth())),
          qe(i, o),
          qe(function (n) {
          ...
          E &&
            (qe(i, s),
            qe(function (t) {
              P.push(t.innerHTML), j.push(Qe(e(t).css("width")));
            }, s),
            qe(function (e, t) {
              e.style.width = j[t];
            }, c),
          ...
          (_.width = Qe(l)),
          (g.width = Qe(l)),
          E && (n.nScrollFoot.style.width = Qe(l)),
          f || (L && (_.height = Qe(D.offsetHeight + h))),
          (N = C.outerWidth()),
          (v[0].style.width = Qe(N)),
          (m.width = Qe(N)),
          ...
          (m[(c = "padding" + (k.bScrollbarLeft ? "Left" : "Right"))] = T
            ...
            : "0px"),
          E &&
            ((x[0].style.width = Qe(N)),
            (w[0].style.width = Qe(N)),
    ...
    function ze(n) {
      var r,
        ...
        v = m.bScrollOversize,
        y =
          ((_ = o.style.width) && -1 !== _.indexOf("%") && (h = _),
          Ve(S(s, "sWidthOrig"), p));
      for (C = 0; C < d.length; C++)
        null !== (r = s[d[C]]).sWidth && ((r.sWidth = y[C]), (g = !0));
      if (v || (!g && !l && !a && u == M(n) && u == f.length))
        for (C = 0; C < u; C++) {
          var b = H(n, C);
          null !== b && (s[b].sWidth = Qe(f.eq(C).width()));
        }
      else {
        var _,
          w =
            ((_ = e(o).clone().css("visibility", "hidden").removeAttr("id"))
              .find("tbody tr")
              .remove(),
            e("<tr/>").appendTo(_.find("tbody")));
        for (
          _.find("thead, tfoot").remove(),
            _.append(e(n.nTHead).clone()).append(e(n.nTFoot).clone()),
            _.find("tfoot th, tfoot td").css("width", ""),
            f = de(n, _.find("thead")[0]),
            C = 0;
          C < d.length;
          C++
        )
        ...
        if (n.aoData.length)
          for (C = 0; C < d.length; C++)
            (r = s[(i = d[C])]),
              e(Xe(n, i)).clone(!1).append(r.sContentPadding).appendTo(w);
        ...
        (o.style.width = Qe(T)), x.remove();
      }
      h && (o.style.width = Qe(h)),
        (!h && !l) ||
          n._reszEvt ||
          ((c = function () {
            e(t).on(
    ...
    function Ge(e) {
      var t,
        ...
        c = (e.aoColumns, 0),
        u = e.aiDisplayMaster;
      for (W(e), t = 0, n = (o = Ye(e)).length; t < n; t++)
        ...
        o.off(n + " " + t + " " + s),
          S(a, "_details").length > 0 &&
            ...
            o.on(t, function (t, n, r, o) {
              if (i === n)
                for (var s, l = M(n), c = 0, u = a.length; c < u; c++)
                  (s = a[c])._details &&
                    s._details.each(function () {
  ...
  (function (e) {
    ...
    return (
      ...
      (i.ext.renderer.pageButton.bootstrap = function (t, o, s, a, l, c) {
        ...
        })(e(o).empty().html('<ul class="pagination"/>').children("ul"), a),
          f !== r &&
            e(o)
              .find("[data-dt-idx=" + f + "]")
              .trigger("focus");
